...
window.onload = function init() {
    ...
    // speed factor location
    loc = gl.getUniformLocation(program, 'speedFactor');
...
function render() {
    ...
    gl.uniform1f(loc, speedFactor);
    gl.drawArrays( gl.TRIANGLES, 16, 21);

    speedFactor += 0.004; // increment the factor for next iteration
